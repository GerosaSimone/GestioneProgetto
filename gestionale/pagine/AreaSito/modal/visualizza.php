...
<div class="form-group mt-2" style="max-height:45%">
    ...
    <div>
        <img id="fotoNews" class="mt-3" src="img/uploadsNews/<?php echo $foto; ?>" style="height: 250px; width: auto; object-fit: cover;max-width:470px" />
    </div>
    <label class="mt-2 text-dark font-weight-bold">Titolo</label><br>

...
<div class="container">
    <div class="row">
        <div class="col-sm-4 border-right">
            ...
            <label>Nome</label>
            <input type="text" name="nomeVisualizza" id="nomeVisualizza" class="form-control form-control-sm mb-2" readonly="readonly" value="<?php echo $id?>">
            <label>Cognome</label>
            ...
            <div class="container" style="margin-left:-2%">
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <input type="currency" name="daPagare" value="0,00€"  class="form-control form-control-sm mb-2" readonly="readonly" />
                    </div>
                    <div class="col-sm-6">
                        <label>Pagato</label>
                        <input type="currency" name="pagato" value="0,00€" class="form-control form-control-sm mb-2" readonly="readonly" />
                    </div>
                </div>
            </div>
        </div>

    ...
    <div class="container-table100">
        <div class="wrap-table100">
            <div class="table100">
                ...
                echo "<table class='display shadow-lg tabellaGiocatoriSquadre' style='width:100%'><thead><tr>";
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            echo "<td>                                            
                                            ...
                                            <button type='button' class='btn btn-outline-info' data-bs-toggle='modal' data-bs-target='#visualizzaGiocatore' data-bs-whatever='" . $row['id'] . "'>

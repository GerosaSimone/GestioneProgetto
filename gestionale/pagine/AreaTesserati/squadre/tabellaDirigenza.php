<div class="page-header clearfix">
    <h4 class="pull-left" style="margin-left:3.5%; margin-top:20px"> Dirigenza </h4>
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            echo "<td class='column4 pr-4'>
                                            <button type='button' class='btn btn-outline-primary' data-bs-toggle='modal' data-bs-target='#visualizzaDirigente' data-bs-whatever='" . $row['id'] . "'>
